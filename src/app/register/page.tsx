          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              <input
                type="email"
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-700 placeholder-gray-500 text-white bg-gray-800 rounded-none focus:outline-none focus:ring-accent focus:border-accent focus:z-10 sm:text-sm"
